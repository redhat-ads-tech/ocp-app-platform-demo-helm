...
Walkthrough, troubleshooting, and the optional scoped-diff scripts live in the [rhdh-templates README](https://github.com/redhat-ads-tech/ocp-app-platform-demo-rhdh-templates).
